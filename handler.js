      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            console.error(`Error retrieving profile picture: ${error}`)
            pp = 'https://telegra.ph/file/fe00fd4637a3127b7908b.jpg' // Assign default image URL
            ppgp = 'https://telegra.ph/file/fe00fd4637a3127b7908b.jpg' // Assign default image URL
          } finally {
